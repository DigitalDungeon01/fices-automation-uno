...
| **0x09** | `BM_SOL_PUMP` | Solenoid Pump | 41 |
| **0x0A** | `BM_MIX_PUMP` | Mixer Pump | 42 (shared) |
...
| Byte ID | Variable Name | Description | Pin |
| :--- | :--- | :--- | :--- |
| **0x0B** | `MM_SOL_PUMP` | Solution Pump | 42 (shared) |
...
| 0x09 | BM_SOL_PUMP | 0x13 | SUB1_VALVE | | |
| 0x0A | BM_MIX_PUMP | 0x14 | SUB2_VALVE | | |
| | | 0x20 | RECIPE_TANK | | |
